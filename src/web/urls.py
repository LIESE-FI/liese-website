...
from .views import (
    index, leaders_view, opportunities_view, opportunity_request, verify_email,
    articles_view, success_email_verification, error_email_verification,
    article_detail, events_view, activities_view, projects_view, project_detail
)
...
urlpatterns = [
    ...
    path('proyectos/', projects_view, name='projects_view'),
    path('proyectos/<int:project_id>/', project_detail, name='project_detail'),
]
